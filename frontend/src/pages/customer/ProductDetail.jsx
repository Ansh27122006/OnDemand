...
const Toast = ({ message, type = "success", onClose }) => (
  <div
    className={`fixed bottom-6 right-6 z-50 flex items-center gap-3 px-5 py-3.5 text-sm font-medium rounded-2xl shadow-2xl animate-slide-up ${
      type === "info"
  ...
  >
    ...
    <button
      onClick={onClose}
      className={`ml-2 transition-colors ${type === "success" ? "text-slate-400 hover:text-white" : "opacity-60 hover:opacity-100"}`}
    >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
          ...
          <div className="flex flex-col gap-5">
            ...
            <div className="flex items-center gap-3 pt-2 flex-wrap">
              ...
              {/* ── Save to Wishlist (customers only) ── */}
              {isCustomer && (
                <button
