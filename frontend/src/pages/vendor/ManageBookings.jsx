...
const StatusBadge = ({ status }) => {
  ...
  return (
    <span
      className={`inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-xs font-semibold capitalize ${styles.badge}`}>
...
const Toast = ({ message, onDismiss }) => (
  <div className="fixed bottom-6 right-6 z-50 flex items-center gap-3 bg-slate-900 text-white text-sm px-5 py-3.5 rounded-xl shadow-2xl animate-fade-in-up">
